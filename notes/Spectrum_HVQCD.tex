...
\begin{align}
m_J^2\left(z\right) = & \left(J - 2 \right) \left[ \frac{2}{l_s^2} \left(1 + \frac{f}{\sqrt{\lambda}} \right) + \frac{J+2}{\lambda^\frac{4}{3}} + e^{-2 A_s} \left( a \ddot{\Phi} + b \left( \ddot{A}_s - {\dot{A}_s}^2 \right) + \right . \right. \notag \\
&\left. \left. + c {\dot{\Phi}}^2 + d \dot{A}_s \dot{\Phi} + e {\dot{\tau}}^2  \right)  \right] \, .
\end{align}
