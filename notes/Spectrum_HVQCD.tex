...
\begin{align}
&V_J\left(u\right) = V_1\left(u\right) + \left(J^2 - 1\right) e^{2 A - \frac{4}{3} \Phi} - \frac{3}{l_s^2} \left(J-1\right) e^{2A} \left(1 + \frac{d}{\sqrt{\lambda}}\right) - \notag \\
& - \left(J-1\right) \left[a \left( G \dot{G} \dot{\Phi} + G^2 \ddot{\Phi} \right) + b \left( G^2 \ddot{A} + G \dot{G} \dot{A} -G^2 \dot{A}^2\right) +c G^2 \dot{\Phi}^2 + d G^2 \dot{\tau}^2 + e G^2 \dot{A}\dot{\Phi}\right]
