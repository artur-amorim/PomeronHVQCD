...
\begin{align}
&\sigma\left(\gamma \gamma \rightarrow X\right) =  \sum_n {\rm Im} \, g^{\gamma \gamma}_n s^{jn-1} \int du e^{-\left(j_n - 2 \right)A } e^{-\frac{10}{3} \Phi} V_f w_s^2  \, e^B \psi_n\left(u\right) \, , \\
...
& \sigma\left( p p \to X \right) = \sum_n {\rm Im} \, g^{p p}_n s^{jn-1} \, , \\
