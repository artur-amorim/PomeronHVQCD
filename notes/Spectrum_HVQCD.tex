...
The last ingredient of our model are the higher spin fields $h_{a_1 \cdots a_J}$ that will mediate the interaction between the external states in the considered scattering states. These fields are dual to the spin J twist two operators made of the gluon fields and quark fields.

Like in IHQCD we describe the proton as a scalar field  that has the following coupling with a spin J field in the graviton's Regge trajectory
\begin{align}
