...
double J(const vector<double> X)
{
    ...
    W1 = X[11]; k1 = X[12]; w1 = X[13]; a1 = X[14]; a2 = X[15]; tau0 = X[16];
    Za = 133; ca = 0.26;
...
int main(int argc, char ** argv)
{
    ...
    else
    {
        ...
        a2 = stod(argv[16]); tau0 = stod(argv[17]);
    }
    ...
    vector<double> x_guess = {sc, ksc, wsc, W0, w0, kU1, wU1, VgIR, WIR, kIR, wIR, W1, k1, w1, a1, a2, tau0};

    vector<double> deltas(x_guess.size(), 0.1);
    ...
    W1 = xop[11]; k1 = xop[12]; w1 = xop[13]; a1 = xop[14]; a2 = xop[15]; xf = 2./3; tau0 = xop[16];
