...
int main(int argc, char ** argv)
{
    ...
    if (argc < 23)
    {
        sc = 3; ksc = 3; wsc = 1.56; W0 = 2.5; w0 = 1.26; wU1 = 0.0; kU1 = 11./9;
    ...
    else
    {
        ...
        kU1 = stod(argv[6]); wU1 = stod(argv[7]); VgIR = stod(argv[8]); WIR = stod(argv[9]); kIR = stod(argv[10]); wIR = stod(argv[11]);
        W1 = stod(argv[12]); k1 = stod(argv[13]); w1 = stod(argv[14]); xf = 2.0/3; tau0 = stod(argv[15]);
        Za = stod(argv[16]); ca = stod(argv[17]);
        int i1 = stoi(argv[18]), i2 = stoi(argv[19]), i3 = stoi(argv[20]), i4 = stoi(argv[21]), i5 = stoi(argv[22]);
    ...
    cout << " kU1: " << kU1 << " wU1: " << wU1 << " VgIR: " << VgIR << " WIR: " << WIR << " kIR: " << kIR << " wIR: " << wIR << " W1: " << W1;
    cout << " k1: " << k1 << " w1: " << w1 << " tau0: " << tau0 << " Za: " << Za << " ca: " << ca << endl;
    // Create HVQCD object
    HVQCD hvqcd(sc, ksc, wsc, W0, w0, kU1, wU1, VgIR, WIR, kIR,
