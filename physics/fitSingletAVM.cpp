...
struct Function
{
    ...
    vector<double> VAVM;
    double rho_mass;
    Function(const double sc, const double ksc, const double wsc, const double W0, const double w0,
            const double kU1, const double wU1, const double VgIR, const double WIR, const double kIR,
            const double wIR, const double W1, const double k1, const double w1, 
            const double a1, const double a2, const double xf, const double tau0);
...
Function::Function(const double sc, const double ksc, const double wsc, const double W0, const double w0,
            const double kU1, const double wU1, const double VgIR, const double WIR, const double kIR,
            const double wIR, const double W1, const double k1, const double w1,
            const double a1, const double a2, const double xf,
            const double tau0): hvqcd(sc, ksc, wsc, W0, w0, kU1, wU1, VgIR, WIR, kIR, wIR, W1, k1, w1, a1, a2, xf, tau0, 0, 0),
...
double Function::operator() (const vector<double> &X)
{
    ...
    {
        cout << "Potential not computed." << endl;
        cout << "erms: " << 1e99 << endl;
        return 1e99;
    }
...
int main(int argc, char ** argv)
{
    ...
    if (argc < 20)
    {
        ...
        w1 = 0.0; a1 = 0.0; a2 = 1.0; tau0 = 1.; Za = 1; ca = 1;
    }
    else
    {
