...
double J(const vector<double> X)
{
    ...
    W1 = X[11]; k1 = X[12]; w1 = X[13]; a2 = 1; a1 = a2*(4+W0*xf)/16.0; tau0 = X[14];
    Za = 133; ca = 0.26;
...
int main(int argc, char ** argv)
{
    double sc, ksc, wsc, W0, w0, kU1, wU1;
    double VgIR, WIR, kIR, wIR, W1, k1, w1;
    double a2 = 1.0, xf = 2.0/3, tau0, Za = 133, ca = 0.26;
    if (argc < 16)
    {
    ...
    W1 = xop[11]; k1 = xop[12]; w1 = xop[13]; a1 = a2*(4+W0*xf)/16.0; xf = 2./3; tau0 = xop[14];
