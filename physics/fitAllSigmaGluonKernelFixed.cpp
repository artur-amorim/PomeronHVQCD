...
int main(int argc, char ** argv)
{
    ...
    double coeff_g;
    int coeff_index;
    double k0g, k1g, k2g, k3g;
    // Gravitational proton couplings
    double kbar0g, kbar1g, kbar2g, kbar3g;
    ...
    else
    {
        ...
        k0g = stod(argv[3]); k1g = stod(argv[4]); k2g = stod(argv[5]); k3g = stod(argv[6]); 
        kbar0g = stod(argv[7]); kbar1g = stod(argv[8]); kbar2g = stod(argv[9]); kbar3g = stod(argv[10]);
    }
    cout << "Starting fit with values:" << endl;
    cout << "coeff_index: " << coeff_index << endl;
    cout << "coeff_g: " << coeff_g << endl;
    cout << "k0g: " << k0g << " k1g: " << k1g << " k2g: " << k2g << " k3g: " << k3g << endl;
    cout << "kbar0g: " << kbar0g << " kbar1g: " << " kbar2g: " << kbar2g << " kbar3g: " << kbar3g << endl;
    ...
    vector<Reggeon> reggeons = {reggeons_gluon[0], reggeons_gluon[1], reggeons_gluon[2], reggeons_gluon[3]};
    ...
    // Start the fit now
    vector<double> X_guess = {k0g, k1g, k2g, k3g, kbar0g, kbar1g, kbar2g, kbar3g};
