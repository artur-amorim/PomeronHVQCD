...
double J(const vector<double> X)
{
    ...
    double xf = 2.0/3, a1, a2, tau0, Za = 133, ca = 0.26;
    ksc = X[0]; wsc = X[1]; W0 = X[2]; w0 = X[3]; kU1 = X[4];
    wU1 = X[5]; WIR = X[6]; kIR = X[7]; wIR = X[8]; W1 = X[9];
    k1 = X[10]; w1 = X[11]; a2 = X[12]; a1 = a2*(4+W0*xf)/16.0;
    tau0 = X[13];
...
int main(int argc, char ** argv)
{
    ...
    else
    {
        ...
        kU1 = stod(argv[5]); wU1 = stod(argv[6]); WIR = stod(argv[7]); kIR = stod(argv[8]);
        wIR = stod(argv[9]); W1 = stod(argv[10]); k1 = stod(argv[11]); w1 = stod(argv[12]);
        a2 = stod(argv[13]); tau0 = stod(argv[14]);
    }
    ...
    wU1 = xop[5]; WIR = xop[6]; kIR = xop[7]; wIR = xop[8]; W1 = xop[9];
    k1 = xop[10]; w1 = xop[11]; a2 = xop[12]; tau0 = xop[13];
